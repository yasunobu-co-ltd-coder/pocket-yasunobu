...
■会議概要
この会議で表面的に話された議題だけでなく、「なぜこの会議が開かれたか」「背景にある本質的な課題」「今後の方針の核心」を3〜5文で凝縮して記述する。
単に「〇〇について議論した」ではなく、会議全体を貫くテーマと結論の方向性を読み手が一目で把握できるように書くこと。

■ステークホルダー整理
会議に登場した人物・組織のスタンスを以下の形式で整理する（3人以上の意見の相違がある場合のみ記載。該当なければ省略）:
| 氏名・役職 | スタンス | 主な意見・懸念 |
|---|---|---|
| ○○氏（役職） | 推進派 / 懐疑派 / 中立 | 具体的な意見や懸念 |
...
■重要ポイント
戦略的に重要な内容をまとめる。「なぜ重要か」に加え、「放置した場合のリスク」「次のアクションとの繋がり」まで含めて記述する。

■課題・リスク
未解決課題や懸念事項（何にどう影響するかを明記する）

■次回に向けたアクションプラン
会議の流れ上確認・合意されたステップを順序立てて記述する（明確なステップが語られた場合のみ。該当なければ省略）:
ステップ1: 〇〇（目的・内容）
ステップ2: 〇〇（目的・内容）
